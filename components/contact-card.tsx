...
import {
  ...
  MessageCircle,
  Facebook,
  Send, // Using 'Send' icon to represent Telegram
} from "lucide-react"
      ...
      <CardContent className="flex-1 p-6 md:p-8 md:w-1/2">
        ...
        <div className="grid gap-4 text-left text-sm text-gray-600">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="tel:+639487191557" className="text-blue-600 hover:underline">
              +63 965 198 3796
            </a>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="sms:+639487191557" className="text-blue-600 hover:underline">
              +63 965 198 3796 (SMS)
            </a>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="https://t.me/639651983796" // Replace with actual Telegram link
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-600 hover:underline"
            >
